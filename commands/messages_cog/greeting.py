        ...
        if any(content_lower.startswith(greet) for greet in self.greetings):
            embed = disnake.Embed(
                ...
                description=(
                    ...
                    "> Если у вас возникнут вопросы или потребуется помощь, не стесняйтесь **обращаться** к администраторам или модераторам через бота.\n\n"
                    "Также, **пожалуйста**, придерживайтесь правил сервера: <#1195867893594869853>"
                ),
